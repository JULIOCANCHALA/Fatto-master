...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new DrawerItem(tagTitles[1], R.drawable.ic_reloj));
        items.add(new DrawerItem(tagTitles[2], R.drawable.ic_reto));
        items.add(new DrawerItem(tagTitles[3], R.drawable.ic_contacto));
        items.add(new DrawerItem(tagTitles[4], R.drawable.ic_ajuste));
        items.add(new DrawerItem(tagTitles[5], R.drawable.ic_acercade));
    ...
    private void selectItem(int position) {
        ...
        switch (position)
        {
            ...
            case 0:
                Nuevalarma fragmentw=new Nuevalarma();

                fragmentw.setArguments(args);

                fragmentManager.beginTransaction().replace(R.id.content_frame, fragmentw).commit();
                break;
            case 1:
